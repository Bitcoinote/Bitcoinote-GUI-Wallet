...
public:
    ...
    QAction *m_aboutBitcoinoteAction;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/bitcoinote"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutBitcoinoteAction = new QAction(MainWindow);
        m_aboutBitcoinoteAction->setObjectName(QStringLiteral("m_aboutBitcoinoteAction"));
        m_aboutBitcoinoteAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutBitcoinoteAction);
        ...
        QObject::connect(m_aboutBitcoinoteAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutBitcoinoteAction->setText(QApplication::translate("MainWindow", "About Bitcoinote", 0));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND BITCOINOTE", 0));
